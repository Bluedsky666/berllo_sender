...
class EmailClientGUI:
    def __init__(self, root):
        ...
        self.root.geometry("800x700") # 增加默认高度
    ...
    def create_push_tab_widgets(self):
        # --- 创建一个带滚动条的框架 ---
        canvas = tk.Canvas(self.push_tab)
        scrollbar = ttk.Scrollbar(self.push_tab, orient="vertical", command=canvas.yview)
    ...
    # --- Other methods (test_api_connection, send, query etc.) remain largely the same, just removed ssl var ---
